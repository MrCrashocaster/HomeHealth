...
export class ChatViewPage implements OnInit {
  ...
  constructor(private userService: UserService, private chatsService: ChatsService, private db : AngularFireDatabase, private utilService : UtilService, private camera: CameraService) { 
